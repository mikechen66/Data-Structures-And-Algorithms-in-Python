...
from favorites_list_7_17 import FavoritesList
from positional_list_7_17 import PositionalList
...
class FavoritesListMTF(FavoritesList):
    ...
    def top(self, k):
        ...
        for j in range(k):
            ...
            yield highPos.element()._value                   # report element to u._node.ser
